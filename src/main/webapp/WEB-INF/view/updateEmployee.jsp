...
var stateObject = {
"India": { 
"Andhrapradesh": ["Anantapur", "Chittur", "East Godavari", "Guntur", "Krishna", "Kurnool", "Prakasam", "Srikakulam", "Nellore", "Visakapatnam", "Vijayanagaram", "West Godavari", "Cudappah"],
...
"chhattisgarh": ["Bastar", "Bemetara", 'Bijapur', "Bilaspur", "Dantewada (South Bastar)", "Dhamtari", "Durg", "Gariyaband", "Janjgir-Champa", "Jashpur", "Kabirdham (Kawardha)", "Kanker (North Bastar)", "Kondagaon", "Korba", "Korea (Koriya)", "Mahasamund", "Mungeli", "Narayanpur", "Raigarh", "Raipur", "Rajnandgaon", "Sukma", "Surajpur", "Surguja"],
"Dadra and Nagar Haweli": ["Amal", "Silvassa"],
"Daman and Diu": ["Daman", "Diu"],
"Delhi": ["new Delhi", "North Delhi", "Noida", "Patparganj", "Sonabarsa", "Tughlakabad"],
...
"Jharkhand": ["Garhwa", "Palamu", "Latehar.", "Chatra", "Hazaribagh", "Koderma", "Giridih", "Ramgarh", "Bokaro", "Dhanbad district", "Lohardaga", "Gumla", "Simdega", "Ranchi", "Khunti", "West Singhbhum", "Saraikela Kharsawan", "East Singhbhum", "Jamtara", "Deoghar", "Dumka", "Pakur", "Godda", "Sahebganj"],
"Karnataka": ["Bagalkot", "Ballari (Bellary)", "Belagavi (Belgaum)", "Bengaluru ", "Bengaluru (Bangalore) Urban", "Bidar", "Chamarajanagar", "Chikballapur", "Chikkamagaluru (Chikmagalur)", "Chitradurga", "Dakshina Kannada", "Davangere", "Dharwad", "Gadag", "Hassan", "Haveri", "Kalaburagi (Gulbarga)", "Kodagu", "Kolar", "Koppal", "Mandya", "Mysuru (Mysore)", "Raichur", "Ramanagara", "Shivamogga (Shimoga)", "Tumakuru (Tumkur)", "Udupi", "Uttara Kannada (Karwar)", "Vijayapura (Bijapur)", "Yadgir"],

"Kerala": ["Alappuza", "Ernakulam", "Idukki", "Kannur", "Kasaragod", "Kollam", "Kottayam", "Kozikkode", "Malappuram", "Palakkad", "Patanamthitta", "Trissur", "Thiruvananthapuram", "Wayanad"],
"Madhya Pradesh": ["Agar Malwa", "Alirajpur", "Anuppur", "Ashoknagar", "Balaghat", "Barwani", "Betul", "Bhind", "Bhopal", "Burhanpur", "Chhatarpur", "Chhindwara", "Damoh", "Datia", "Dewas", "Dhar", "Dindori", "Guna", "Gwalior", "Harda", "Hoshangabad", "Indore", "Jabalpur", "Jhabua", "Katni", "Khandwa", "Khargone", "Mandla", "Mandsaur", "Morena", "Narsinghpur", "Neemuch", "Panna", "Raisen", "Rajgarh", "Ratlam", "Rewa", "Sagar", "Satna", "Sehore", "Seoni", "Shahdol", "Shajapur", "Sheopur", "Shivpuri", "Sidhi", "Singrauli", "Tikamgarh", "Ujjain", "Umaria", "Vidisha"],
"Sikkim": ["Chamurci", "Gangtok"],
"Tamilnadu": ["Ariyalur", "Chennai", "Coimbatore", "Cuddalore", "Dharmapuri", "Dindigul", "Erode", "Kancheepuram", "Karur", "Krishnagiri", "Madurai", "Nagapattinam", "Kanyakumari", "Namakkal", "Perambalur", "Pudukottai", "Ramanathapuram", "Salem", "Sivagangai", "Thanjavur", "Theni", "Thiruvallur", "Thiruvarur", "Tuticorin", "Trichirappalli", "Thirunelveli", "Tiruppur", "Thiruvannamalai", "The Nilgiris", "Vellore", "Viluppuram", "Virudhunagar"],
"Telangana": ["Hyderabad", "Karimnagar", "Medak", "Nalgonda", "Nizamabad", "Rangareddy", "Warangal"],
"Tripura": ["Dhalai", "Gomati", "Khowai", "North Tripura", "Sepahijala", "South Tripura", "Unakoti", "West Tripura"],
"Uttar Pradesh": ["Agra", "Aligarh", "Allahabad", "Ambedkar Nagar", "Amethi", "Amroha", "Auraiya", "Azamgarh", "Baghpat", "Bahraich", "Ballia", "Balrampur", "Banda", "Barabanki", "Bareilly", "Basti", "Bijnor", "Budaun", "Bulandshahr", "Chandauli", "	Chitrakoot", "Deoria", "Etah", "Etawah", "Faizabad", "Farrukhabad", "Fatehpur", "Firozabad", "Gautam Buddha Nagar", "Ghaziabad", "Ghazipur", "Gonda", "Gorakhpur", "Hamirpur", "Hardoi", "Hathras", "Jalaun", "Jaunpur", "Jhansi", "Jyotiba Phule Nagar", "Kannauj", "Kanpur Dehat", "Kanpur Nagar", "Kanshiram Nagar", "Kaushambi", "Kheri", "	Kushinagar", "Lalitpur", "Lucknow", "Maharajganj", "Mahoba", "Mainpuri", "Mathura", "Mau", "Meerut", "Meerut", "Moradabad", "Muzaffarnagar", "Pilibhit", "Pratapgarh", "RaeBareli", "Rampur", "Saharanpur", "Sambhal (Bhim Nagar)", "Sant Kabir Nagar", "Shahjahanpur", "Shamali (Prabuddh Nagar)", "Shravasti", "Siddharth Nagar", "Sitapur", "Sonbhadra", "Sultanpur", "Unnao", "Varanasi"],
...
<!-- sidebar -->
    <div class="sidebar-offcanvas" id="sidebar">
                   <a href=""> <div class="logo"><img src="/images/logo.gif" /></div></a>
                     <ul class="nav" id="myMenu">                                          
                       <li id="item2"><a href="employee.html"><i class="fa fa-home"></i> <span class="collapse in hidden-xs">Home</span></a></li>
                        <li id="item3"><a href="add-employee.html"><i class="fa fa-users"></i> <span class="collapse in hidden-xs">Employee Details</span></a></li>
                        <li id="item4"><a href="salarystructure.html"><i class="fa fa-money"></i> <span class="collapse in hidden-xs">Salary Structure</span></a></li>
                        <li id="item5"><a href="deductions.html"><i class="fa fa-minus"></i> <span class="collapse in hidden-xs">Deductions</span></a></li>
			            <li id="item1"><a href=""><i class="fa fa-sign-out"></i><span class="collapse in hidden-xs"> Log Out</a></li>
...
<div class="top-nav">
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 title_stats_count">
              <div class="count_bottom"><i class="fa fa-user"></i> Total Employees</div>  
                 <a href=""><div class="count green"></div> </a>          
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 title_stats_count">
              <div class="count_center"><i class="fa fa-user"></i> Managers</div>
                 <a href=""><div class="count green"></div></a>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 title_stats_count noborder">
              <div class="count_bottom"><i class="fa fa-users"></i> Total Project Groups</div>
             <a href=""> <div class="count green"></div></a>
...
<!-- Header -->
                    ...
                    <div class="form-fields">
                                <form action="employeeinfo.html" name="validation" role="form" action="" method="post" onsubmit="return validate();">
                                <div class="sidehead">Personal Information</div>                    
                                  
                                  <div class="form-group">
                                      <div>
                                          <label class="lable-name">Employee Number * </label>
                                          <input type="text" class="input-name" id="employeenumber" name="employeenumber" value="" required="" />
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <div>
                                         ...
                                         <input  type="text" class="input-name" id="gender" name="gender" value="" required="" />
                                      </div>
                                  </div>
                                   ...
                                   <div class="form-group">
                                      <div>
                                          ...
                                          <input type="text" class="input-name" name="bday" id="bday" value="" required="">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <div>
                                    ...
                                    <div class="form-group">
                                      <div>
                                          <label class="lable-name">Marital Status * </label>
	                                       <input type="text" class="input-name" id="maritalstatus" name="maritalstatus" value="" required="" />
                                      </div>
                                  </div>
                    ...
                    <div class="form-group">
                                      <div>
                                          ...
                                          <input type="password" class="input-name" id="password" name="password" value="" required="" />
                                      </div>
                                  </div>
                  ...
                  <div class="form-group">
                                      <div>
                                          ...
                                          <input type="text" class="input-name" id="doornum" name="doornum" value="" required="" />
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <div>
                                          ...
                                          <input type="text" class="input-name" name="state" id="countySel" size="1" />
                                  ...
                                  <div class="form-group">
                                      <div>
                                        ...
                                        <input type="text" class="input-name" name="countrya" id="stateSel" size="1" />
                                      </div>
                                      </div>
                                  <div class="form-group">
                                     <div>
                                       <label class="lable-name">District * </label> 
                                       <input type="text" class="input-name" name="district" id="districtSel" size="1" />
                                     </div>
                                </div>
                            <div class="form-group">
                                      <div>
   ...
   <div class="sidehead">Assignment Information</div>
                             ...
                             <div class="form-group">
                                      <div>
                                          ...
                                          <input type="text" class="input-name" name="startdate">
                                      </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                      <div>
                                          ...
                                          <input type="text" class="input-name" name="enddate">
                                      </div>
                                </div>
                                 <div class="form-group">
                                      <div>
                                  ...
                                  <div class="form-group">
                                      <div>
                                          ...
                                          <input type="text" class="input-name" name="joindate">
                                      </div>
                                </div>
                                   <div class="form-group">
                                      <div>
 ...
 <div class="sidehead">Bank Information:</div>
                               <div class="form-group">
                                      <div>
                                          ...
                                          <input  type="text" class="input-name" id="bankname" name="bankname" value="" required=""/>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <div >
                                          <label class="lable-name">Account Number * </label>
                                          <input type="text" class="input-name" id="accountnumber" name="accountnumber" value="" required="" />
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <div >
...
<div class="sidehead">Provident Fund Information:</div>
                                  ...
                                  <div class="form-group">
                                      <div >
                                          ...
                                          <input type="text" class="input-name" id="previousemp" name="previousemp" value="" required="" />
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <div>
                                          <label class="lable-name">Date of Previous Employee Leaving * </label>
                                          <input type="text" class="input-name" name="previousempleavingdate">
                                      </div>
                                </div>
                                <div class="form-group">
                                      <div>
                                          <label class="lable-name">Start Date* </label>
                                          <input type="text" class="input-name" name="previousempstartdate">
                                      </div>
                                </div>
                                 <div class="form-group">
                                      <div>
                                          <label class="lable-name">End Date* </label>
                                          <input type="text" class="input-name" name="previousempenddate">
                                      </div>
                                </div>
					<div class="ln_solid"></div>
                                        <div class="buttons col-md-6 col-md-offset-3">        				
                		           <input class="btn btn-info" id="submit" name="submit" type="submit" value="Save"> 
                                           <input class="btn btn-cancel" id="submit" name="submit" value="Cancel" onclick="window.location.href='employee.html'">
              	                     </div>              
                              </form>
                            
                 <div class="footer">
                 <p>Copyright &copy; <script>document.write(new Date().getFullYear())</script> Centraprise, LLC. All Rights Reserved.</p>
                </div>
                    </div>
                      </div>
                  </div>
